...
@section('content')
    ...
    <h2 class="alert alert-warning">Licencias de Planeación</h2>
...
<li><a href="{{ route('licenciasplaneacion.create') }}" class="btn btn-primary">Nueva Licencia de Planeación</a></li>
@stop