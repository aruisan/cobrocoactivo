...
@section('content')
    <h2 class="alert alert-warning">Comité de Conciliación</h2>
...
@stop
@section('sidebar')
<li><a href="{{ route('comiteconciliacion.create') }}" class="btn btn-primary">Nuevo Comité de Conciliación</a></li>
@stop