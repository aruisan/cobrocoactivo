<li class="dropdown">
      <a class="dropdown-toggle btn btn btn-success" data-toggle="dropdown" href="#">
        ...
        <ul class="dropdown-menu dropdown-user">
          <li>
            <a href="{{route('funcionarios.index')}}" class="btn btn-success"><i class="material-icons md-12ss">list</i> Ver </a>
            </li>
            <li>
            <a href="{{route('funcionarios.create')}}" class="btn btn-success"><i class="material-icons md-12ss">create</i> Crear</a>
            </li>
        </ul>
    </li>
