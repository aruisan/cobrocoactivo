...
@section('sidebar')
    ...
    @if($OrdenPago->estado == 1)
        <li> <a href="{{ url('/administrativo/ordenPagos/pdf/'.$OrdenPago->id) }}" class="btn btn-success"><span class="hide-menu"><i class="fa fa-file-pdf-o"></i>&nbsp; Orden de Pago</span></a></li>
        <li> <a href="{{ url('/administrativo/egresos/pdf/'.$OrdenPago->id) }}" class="btn btn-success"><span class="hide-menu"><i class="fa fa-file-pdf-o"></i> &nbsp; Comprobante de Egresos</span></a></li>
    @else
