...
<div class="row">
    <div class="col-lg-12 margin-tb">
            <h2 class="text-center"> Creación de Marca</h2>
    </div>
</div>

        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
            {!! Form::open(array('route' => 'marcas-herretes.store','method'=>'POST',  'files' => true)) !!}
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" name="ff_exp" required="required">
                        </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-file-archive-o" aria-hidden="true"></i></span>
                            <input type="date" class="form-control" name="ff_venc" required="required">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="persona_id" id="aidentificador" data-toggle="modal" data-target="#participante" required="required">
                        </div>
                    ...
                    <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="persona_nombre" id="anombre" data-toggle="modal" data-target="#participante">
                        </div>
                        <small class="form-text text-muted">relacionar persona</small>
                    </div>                
