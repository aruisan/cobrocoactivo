...
<ul class="progress-tracker progress-tracker--vertical">
    ...
    @elseif($registro->secretaria_e == 3 and $registro->jcontratacion_e == 0 and $registro->jpresupuesto_e == 1 )
        <li class="progress-step is-complete">
            <span class="progress-marker"></span>
            <span class="progress-text">
              <h4 class="progress-title">Secretaria</h4>
    ...
    @elseif($registro->secretaria_e == 3 and $registro->jcontratacion_e == 3 and $registro->jpresupuesto_e == 3 )
        <li class="progress-step is-complete">
            <span class="progress-marker"></span>
            <span class="progress-text">
              <h4 class="progress-title">Secretaria</h4>
