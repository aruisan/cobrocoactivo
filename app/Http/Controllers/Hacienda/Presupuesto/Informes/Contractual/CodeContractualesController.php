...
class CodeContractualesController extends Controller
{
    ...
    public function report(Request $request){
        ...
        if ($data->count() != 0){
            ...
            Session::flash('error','Actualmente ningun rubro esta asignado a ese codigo contractual.');
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(CodeContractuales $codeContractuales)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, CodeContractuales $codeContractuales)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(CodeContractuales $codeContractuales)
    {
        //
    }
}
